# This is a patched version of the standard create_resources function that
# ships with Puppet. The singleton module depends on the "name" parameter
# being respected by the create_resources function, and so will ship with this
# patched version until http://projects.puppetlabs.com/issues/13567 is
# resolved.
